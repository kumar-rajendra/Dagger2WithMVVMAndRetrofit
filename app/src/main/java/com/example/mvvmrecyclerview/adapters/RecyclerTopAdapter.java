...
public class RecyclerTopAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private List<NicePlace> nicePlaces = new ArrayList<>();
    private Context mContext;

    public RecyclerTopAdapter(Context context, List<NicePlace> nicePlaces) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_list_top,parent,false);
    ...
    private class ViewHolder extends RecyclerView.ViewHolder{
       // private TextView mName;
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            mImage=itemView.findViewById(R.id.img_image_top);
        }
    }
}
